...
export default defineComponent({
  ...
  render: function render() {
    ...
    var classes = classNames((_classNames = {}, _defineProperty(_classNames, className, className), _defineProperty(_classNames, prefixCls, true), _defineProperty(_classNames, "".concat(prefixCls, "-disabled"), disabled), _defineProperty(_classNames, "".concat(prefixCls, "-focused"), this.focused), _classNames));
    var upDisabledClass = '';
    ...
    }, [createVNode("span", null, [createVNode(InputHandler, _objectSpread(_objectSpread({}, upHandlerProps), {}, {
      "key": "upHandler"
    }), {
    ...
    })]), createVNode(InputHandler, _objectSpread(_objectSpread({}, downHandlerProps), {}, {
      "key": "downHandler"
    }), {
      default: function _default() {
