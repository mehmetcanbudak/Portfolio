import { Comment, inject, createVNode } from "vue";
...
import { initDefaultProps, getOptionProps, getComponent, splitAttrs, getPropsData } from '../_util/props-util';
...
var SubPopupMenu = {
  ...
  methods: {
    ...
    renderCommonMenuItem: function renderCommonMenuItem(child, i, extraProps) {
      ...
      return createVNode(FunctionProvider, newChildProps, {
  ...
  render: function render() {
    ...
    return (// ESLint is not smart enough to know that the type of `children` was checked.
      ...
      /* eslint-disable */
      createVNode(DOMWrap, domWrapProps, {
        default: function _default() {
