...
var _default2 = (0, _vue.defineComponent)({
  ...
  render: function render() {
    ...
    var calendarClassName = (0, _classNames2.default)((_classNames = {}, _defineProperty(_classNames, "".concat(prefixCls, "-time"), showTime), _defineProperty(_classNames, "".concat(prefixCls, "-range-with-ranges"), ranges), _classNames)); // 需要选择时间时，点击 ok 时才触发 onChange
    ...
    var calendar = (0, _vue.createVNode)(_RangeCalendar.default, rangeCalendarProps, _objectSpread({}, $slots)); // default width for showTime
    ...
    }, (0, _util.getDataAndAriaProps)(props)), [(0, _vue.createVNode)(_Picker.default, vcDatePickerProps, _objectSpread({}, _extends({
      default: input
    }, $slots)))]);
  }
});
