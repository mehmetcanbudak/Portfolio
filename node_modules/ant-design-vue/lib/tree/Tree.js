...
var _CaretDownFilled = _interopRequireDefault(require("@ant-design/icons-vue/CaretDownFilled"));

var _MinusSquareOutlined = _interopRequireDefault(require("@ant-design/icons-vue/MinusSquareOutlined"));

var _PlusSquareOutlined = _interopRequireDefault(require("@ant-design/icons-vue/PlusSquareOutlined"));
...
function TreeProps() {
  return {
    ...
    /** （受控）选中复选框的树节点 */
    checkedKeys: _vueTypes.default.oneOfType([_vueTypes.default.array, _vueTypes.default.shape({
      checked: _vueTypes.default.array,
      halfChecked: _vueTypes.default.array
    }).loose]),
    ...
    updateTreeData: function updateTreeData(treeData) {
      ...
      return treeData.map(function (item) {
        ...
        var _item$slots = item.slots,
            ...
            cls = item.class,
            style = item.style,
            restProps = __rest(item, ["slots", "scopedSlots", "class", "style"]);

        var treeNodeProps = _extends(_extends({}, restProps), {
          icon: $slots[scopedSlots.icon] || $slots[slots.icon] || restProps.icon,
          switcherIcon: $slots[scopedSlots.switcherIcon] || $slots[slots.switcherIcon] || restProps.switcherIcon,
          title: $slots[scopedSlots.title] || $slots[slots.title] || $slots.title || restProps[replaceFields.title],
          dataRef: item,
          key: key,
          class: cls,
          style: style
