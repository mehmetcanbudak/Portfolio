...
var updateDefaultActiveFirst = function updateDefaultActiveFirst(store, eventKey, defaultActiveFirst) {
  ...
  store.setState({
    defaultActiveFirst: _extends(_extends({}, state.defaultActiveFirst), _defineProperty({}, menuId, defaultActiveFirst))
  });
};
...
var SubMenu = {
  ...
  props: {
    ...
    selectedKeys: _vueTypes.default.array.def([]),
    ...
    forceSubMenuRender: _vueTypes.default.looseBool.def(true),
    ...
    isOpen: _vueTypes.default.looseBool,
  ...
  created: function created() {
    (0, _vue.provide)('parentMenu', this);
  },
  data: function data() {
  ...
  computed: {
    isChildrenSelected: function isChildrenSelected() {
      return Object.values(this.childrenSelectedStatus).find(function (status) {
        return status;
      });
    }
  },
  ...
  methods: {
    updateParentMenuSelectedStatus: function updateParentMenuSelectedStatus() {
      var status = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : this.isChildrenSelected;
    ...
    setChildrenSelectedStatus: function setChildrenSelectedStatus(key, status) {
      if (!status) {
    ...
    renderChildren: function renderChildren(children) {
      ...
      return (0, _vue.createVNode)(_transition.Transition, transitionProps, {
        default: function _default() {
          return [(0, _vue.withDirectives)((0, _vue.createVNode)(_SubPopupMenu.default, subPopupMenuProps, null), [[_vue.vShow, props.isOpen]])];
        }
      });
    }
  },
  render: function render() {
    var _className, _createVNode;
    ...
    var childrenTemp = (0, _propsUtil.filterEmpty)((0, _propsUtil.getSlot)(this));
    var children = this.renderChildren(childrenTemp);
    ...
    return (0, _vue.createVNode)("li", _objectSpread(_objectSpread({}, liProps), {}, {
      "role": "menuitem"
    }), [isInlineMode && title, isInlineMode && children, !isInlineMode && (0, _vue.createVNode)(_vcTrigger.default, (_createVNode = {
      "prefixCls": prefixCls,
      "popupClassName": popupClassName,
      "getPopupContainer": getPopupContainer,
      "builtinPlacements": _placements.default
    }, _defineProperty(_createVNode, "builtinPlacements", _extends({}, _placements.default, props.builtinPlacements)), _defineProperty(_createVNode, "popupPlacement", popupPlacement), _defineProperty(_createVNode, "popupVisible", isOpen), _defineProperty(_createVNode, "popupAlign", popupAlign), _defineProperty(_createVNode, "action", props.disabled ? [] : [props.triggerSubMenuAction]), _defineProperty(_createVNode, "mouseEnterDelay", props.subMenuOpenDelay), _defineProperty(_createVNode, "mouseLeaveDelay", props.subMenuCloseDelay), _defineProperty(_createVNode, "onPopupVisibleChange", this.onPopupVisibleChange), _defineProperty(_createVNode, "forceRender", props.forceSubMenuRender), _defineProperty(_createVNode, "popup", children), _createVNode), {
      default: function _default() {
        return [title];
      }
    })]);
...
}, _FunctionProvider.injectExtraPropsKey)(SubMenu);
connected.isSubMenu = true;
var _default2 = connected;
