...
var _FunctionProvider = _interopRequireDefault(require("./FunctionProvider"));
...
function updateActiveKey(store, menuId, activeKey) {
  ...
  store.setState({
    activeKey: _extends(_extends({}, state.activeKey), _defineProperty({}, menuId, activeKey))
  });
}
...
var SubPopupMenu = {
  ...
  props: (0, _propsUtil.initDefaultProps)({
    ...
    defaultActiveFirst: _vueTypes.default.looseBool,
  ...
  created: function created() {
    ...
    props.store.setState({
      activeKey: _extends(_extends({}, props.store.getState().activeKey), _defineProperty({}, props.eventKey, getActiveKey(props, props.activeKey)))
    });
    this.instanceArray = [];
  },
  ...
  methods: {
    ...
    renderCommonMenuItem: function renderCommonMenuItem(child, i, extraProps) {
      ...
      return (0, _vue.createVNode)(_FunctionProvider.default, newChildProps, {
...
var _default2 = (0, _store.connect)(undefined)(SubPopupMenu);
