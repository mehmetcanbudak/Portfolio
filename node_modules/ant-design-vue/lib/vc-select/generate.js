...
var BaseProps = function BaseProps() {
  return {
    ...
    tokenSeparators: _vueTypes.default.array,
...
function generateSelector(config) {
  ...
  var Select = (0, _vue.defineComponent)({
    ...
    setup: function setup(props) {
      ...
      var mergedValue = (0, _vue.ref)(undefined);
      ...
      var getValueOption = (0, _useCacheOptions.default)(mergedRawValue.value, mergedFlattenOptions); // Display options for OptionList
      ...
      var onInternalKeyDown = function onInternalKeyDown(event) {
        ...
        if (!mergedOpen.value && which === _KeyCode.default.ENTER) {
          onToggleOpen(true);
        }
    ...
    render: function render() {
      ...
      if (mergedShowArrow) {
        arrowNode = (0, _vue.createVNode)(_TransBtn.default, {
          "class": (0, _classNames3.default)("".concat(prefixCls, "-arrow"), _defineProperty({}, "".concat(prefixCls, "-arrow-loading"), loading)),
      ...
      var mergedClassName = (0, _classNames3.default)(prefixCls, className, (_classNames2 = {}, _defineProperty(_classNames2, "".concat(prefixCls, "-focused"), mockFocused), _defineProperty(_classNames2, "".concat(prefixCls, "-multiple"), isMultiple), _defineProperty(_classNames2, "".concat(prefixCls, "-single"), !isMultiple), _defineProperty(_classNames2, "".concat(prefixCls, "-allow-clear"), allowClear), _defineProperty(_classNames2, "".concat(prefixCls, "-show-arrow"), mergedShowArrow), _defineProperty(_classNames2, "".concat(prefixCls, "-disabled"), disabled), _defineProperty(_classNames2, "".concat(prefixCls, "-loading"), loading), _defineProperty(_classNames2, "".concat(prefixCls, "-open"), mergedOpen), _defineProperty(_classNames2, "".concat(prefixCls, "-customize-input"), customizeInputElement), _defineProperty(_classNames2, "".concat(prefixCls, "-show-search"), mergedShowSearch), _classNames2));
      return (0, _vue.createVNode)("div", _objectSpread(_objectSpread({
        ...
        default: function _default() {
          return [(0, _vue.createVNode)(_Selector.default, _objectSpread(_objectSpread({}, _this.$props), {}, {
  ...
  Select.props = (0, _initDefaultProps.default)(BaseProps(), {});
  return Select;
}